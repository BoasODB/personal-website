...
// Command Input------------------------------
  ...
  $('input[type="text"]').keyup(function(e){
    ...
    if(e.which == 13){// ENTER key pressed
      ...
      if(destination == "theme dark"){
        document.getElementById("html").style.backgroundColor = "black";
        document.getElementById("change").style.color = "white";
        document.getElementById("commander").style.color = "#ffffff"
        document.getElementById("inputje").style.backgroundColor = "transparent";
        document.getElementById("inputje").style.color = "#f1f1f1";
      }
      if(destination == "theme light"){
        document.getElementById("html").style.backgroundColor = "black";
        document.getElementById("change").style.color = "white";
        document.getElementById("commander").style.color = "#ffffff"
        document.getElementById("inputje").style.backgroundColor = "transparent";
